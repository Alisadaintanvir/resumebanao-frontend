      ...
      <section className="relative flex-1 flex flex-col items-center justify-center py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground hidden sm:block">No credit card required</p>
          </motion.div>
        </div>
      </section>

      {/* Features Section */}
      <section id="features" className="py-24 bg-muted/50 border-t border-border relative z-10">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-foreground">Why Choose NeoResume?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">Everything you need to land your next big opportunity.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl glass hover:-translate-y-1 transition-transform">
              ...
              <h3 className="text-xl font-semibold mb-3 text-foreground">ATS-Friendly Templates</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="p-6 rounded-2xl glass hover:-translate-y-1 transition-transform">
              ...
              <h3 className="text-xl font-semibold mb-3 text-foreground">Private &amp; Secure</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
