  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Your Resumes</h1>
          <p className="text-muted-foreground mt-1">Manage and edit your existing CVs</p>
        </div>
      </div>
      ...
      >
        ...
        <Link href="/builder" className="group">
          <div className="h-64 rounded-2xl border-2 border-dashed border-border bg-card/50 flex flex-col items-center justify-center p-6 transition-all hover:bg-primary/5 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 group-hover:-translate-y-1">
            ...
            <h3 className="text-lg font-semibold text-foreground group-hover:text-primary transition-colors">Start from Scratch</h3>
            <p className="text-center text-sm text-muted-foreground mt-2 max-w-[200px]">Create an empty resume layout</p>
          </div>
        </Link>
